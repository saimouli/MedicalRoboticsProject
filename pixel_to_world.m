...
markers_cam(1,1)= (-KK(1,1)*centroids(1,1))/Z + KK(1,3);
markers_cam(1,2)= (-KK(2,2)*centroids(1,2))/Z+ KK(2,3);

markers_cam(2,1)= (-KK(1,1)*centroids(2,1))/Z + KK(1,3);
markers_cam(2,2)= (-KK(2,2)*centroids(2,2))/Z+ KK(2,3);

markers_cam(3,1)= (-KK(1,1)*centroids(3,1))/Z + KK(1,3);
markers_cam(3,2)= (-KK(2,2)*centroids(3,2))/Z+ KK(2,3);
